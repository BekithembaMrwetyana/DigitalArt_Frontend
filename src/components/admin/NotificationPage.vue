          ...
          <div v-for="notification in notifications" :key="notification.notificationId" class="notification-card">
            <div class="notification-content">
              <div class="notification-header">
                ...
                <button @click="markAsRead(notification.notificationId)" :disabled="notification.readStatus"
                  class="read-button">
                  {{ notification.readStatus ? 'Read' : 'Mark as Read' }}
                </button>
              </div>
              <div class="notification-status" :class="{ 'unread': !notification.readStatus }">
                <div v-if="!notification.readStatus" class="unread-indicator"></div>
              </div>
            </div>
          </div>
        </div>
